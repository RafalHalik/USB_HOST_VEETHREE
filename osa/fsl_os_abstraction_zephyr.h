...
// Assuming struct k_mutex is defined somewhere in your code or included headers
typedef struct k_mutex* osa_mutex_handle_t;

// Assuming struct event_handle is defined somewhere in your code or included headers
typedef struct event_handle* osa_event_handle_t;

// Assuming struct data_item_type is defined somewhere in your code or included headers
typedef struct vg_lite_queue_t* osa_msg_handle_t;

// Assuming struct k_msgq is defined somewhere in your code or included headers
typedef struct k_msgq* osa_msgq_handle_t;
...
// osa_status_t OSA_MsgQCreate(msg_queue_t msgqHandle, uint32_t msgNo, uint32_t msgSize);
