...
#define USB_LINK_NONCACHE_NONINIT_DATA _Pragma("location = \".nocache\"")
#elif defined(__CC_ARM) || (defined(__ARMCC_VERSION))
...
#endif
#if defined(__CC_ARM)
#define USB_LINK_NONCACHE_NONINIT_DATA __attribute__((section(".nocache"))) __attribute__((zero_init))
#else
#define USB_LINK_NONCACHE_NONINIT_DATA __attribute__((section(".bss..nocache")))
#endif
...
#define USB_LINK_NONCACHE_NONINIT_DATA __attribute__((section(".nocache, \"aw\", %nobits @")))
...
#define USB_DMA_DATA_INIT_SUB    USB_LINK_DMA_INIT_DATA(.nocache.init)
#define USB_CONTROLLER_DATA      USB_LINK_NONCACHE_NONINIT_DATA
#else
...
#if (defined(USB_DEVICE_CONFIG_BUFFER_PROPERTY_CACHEABLE) && (USB_DEVICE_CONFIG_BUFFER_PROPERTY_CACHEABLE)) || \
    (defined(USB_HOST_CONFIG_BUFFER_PROPERTY_CACHEABLE) && (USB_HOST_CONFIG_BUFFER_PROPERTY_CACHEABLE))
#define USB_DMA_DATA_.nocache USB_LINK_NONCACHE_NONINIT_DATA

#else
#define USB_DMA_DATA_.nocache
#endif

#define USB_GLOBAL_DEDICATED_RAM USB_LINK_USB_GLOBAL

/* #define USB_RAM_ADDRESS_NONCACHEREG_ALIGNMENT(n, var) AT_.nocache_SECTION_ALIGN(var, n) */
/* #define USB_RAM_ADDRESS_NONCACHEREG(var) AT_.nocache_SECTION(var) */
